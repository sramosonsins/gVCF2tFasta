...
int main(int argc, char** argv) {
    ...
    if (vcfname == "")
    {
        ...
        // std::cout << std::endl;
        log_error("VCF file not defined");
        return 1;
    }
    if (refname == "")
    {
        ...
        // std::cout << std::endl;
        log_error("Reference fasta file not defined");
        return 1;
    }
    if (tfastaname == "")
    {
        ...
        // std::cout << std::endl;
        log_error("Output tFasta file name not defined");
    ...
    else
    {
        ...
        // std::cout << std::endl;
        log_info("ncorrect imputation value (different to 0 or 1)");
        return 1;
    }
    std::cout << std::endl;
